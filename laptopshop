...
int main()
{
    ...
    do
    {
        ...
        case 1:
        {
            laptop.take_order(); // Function add
            break;
        } // End case 1

        case 2:
        {
            laptop.delete_order(); // Function delete
            system("PAUSE");
            break;
        } // End case 2
        ...
        case 4:
        {
            laptop.order_list(); // Function order
            system("PAUSE");
            break;
        } // End case 4
        case 5:
        {
            laptop.daily_summary(); // Function daily_summary
            system("PAUSE");
            break;
        } // End case 5
